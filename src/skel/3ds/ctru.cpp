...
#define HEAP_SPLIT_SIZE_CAP  (60 << 20) // 24MB
#define LINEAR_HEAP_SIZE_CAP (60 << 20) // 32MB
...
u32 __ctru_linear_heap_size	= (60 << 20);
...
void __system_allocateHeaps(void) {
	...
	// for APPLICATION this is equal to APPMEMALLOC at all times
